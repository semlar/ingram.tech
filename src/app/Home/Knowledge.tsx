...
const features = [
...

    {
      name: 'Evolving',
      description:
        `In the evolving landscape of artificial intelligence, there
    ...
    },
    {
      name: 'Expertise',
      description:
        `Our expertise lies in sculpting this force to perfection. We
    ...
    },
    {
      name: 'Imagine',
      description:
        `Imagine conversational agents that rival human interactions,
    ...
    <div className="bg-zinc-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-400">Chat Faster</h2>

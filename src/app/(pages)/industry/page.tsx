						...
						<div>
							...
							<ul>
								...
								<li>
									...
									document review, legal research, and analysis to
									meet unique legal needs, especially in enhancing
									customer support through advanced chatbots.
								</li>
							</ul>
						</div>
					</div>
					<div className="text-base font-semibold leading-7 text-white grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 items-center justify-between">
						...
						<div>
							...
							<ul>
								...
								<li>
									<span>
										AI property management tasks assistants:
									</span>{" "}
									Tailor advanced AI tools for property management,
						...
						<div>
							...
							<ul>
								...
								<li>
									...
									distinctive needs of your legal practice,
									particularly in streamlining processes with
									AI-powered insights.
								</li>
							</ul>
						</div>
						...
						<div>
							...
							<ul>
								...
								<li>
									...
									review, legal research, and analysis to meet the
									distinctive needs of your legal practice,
									particularly in shaping AI-driven marketing
									strategies.
								</li>
							</ul>
						</div>
						...
						<div>
							...
							<ul>
								...
								<li>
									...
									needs of your legal practice, particularly in
									providing AI tutors for various subjects.
								</li>
							</ul>
						</div>
					</div>
